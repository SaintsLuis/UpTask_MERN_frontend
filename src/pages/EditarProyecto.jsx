// Objetivo: editar un proyecto existente
...
const EditarProyecto = () => {
  // Obtenemos el id desde la URL con la función useParams
      ...
      <div className='flex justify-between'>
        ...
        <div className='flex items-center gap-2 text-gray-400 hover:text-black cursor-pointer'>
          ...
          <button
            ...
            onClick={() => AlertDelete(eliminarProyecto, params.id)}
          >
            Eliminar
          </button>
        </div>
