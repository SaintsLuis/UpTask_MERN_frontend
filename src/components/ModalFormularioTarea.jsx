...
const ModalFormularioTarea = () => {
  ...
  useEffect(() => {
    // Si hay una tarea seleccionada(Editar), la seteamos en el state
    if (tarea?._id) {
      setId(tarea._id);
  ...
  const handleSubmit = async e => {
    ...
    const fechaEntregaFormateada = new Date(fechaEntrega).getTime();
    if (fechaEntregaFormateada < fechaActual) {
      showNotification(
        'La fecha de entrega debe ser mayor a la fecha actual',
        'error',
      );
      return;
    }
